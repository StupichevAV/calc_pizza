import 'package:calc_pizza/utils/global_theme.dart';
...
class ThemesDemoApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const PizzaCalculatorScreenTheme(),
    );
  }
}

class PizzaCalculatorScreenTheme extends StatefulWidget {
  const PizzaCalculatorScreenTheme({Key? key}) : super(key: key);
...
class _PizzaCalculatorScreenState extends State<PizzaCalculatorScreenTheme> {
